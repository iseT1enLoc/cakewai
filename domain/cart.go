...
type CartItem struct {
	...
	ProductType primitive.ObjectID `json:"type_id" bson:"type_id"`
...
type CartUsecase interface {
	...
	AddCartItemIntoCart(context context.Context, userID primitive.ObjectID, item CartItem) (*CartItem, error)
